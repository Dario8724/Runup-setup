package pt.iade.ei.runupsetup.data.network

import pt.iade.ei.runupsetup.data.dto.HistoryItemDto
import pt.iade.ei.runupsetup.data.dto.CorridaDetalheDto
import pt.iade.ei.runupsetup.data.dto.CorridaGeradaDto
import pt.iade.ei.runupsetup.data.dto.GenerateCorridaRequestDto
import pt.iade.ei.runupsetup.data.dto.FinalizarCorridaRequestDto
import pt.iade.ei.runupsetup.data.dto.GoalDto
import pt.iade.ei.runupsetup.data.dto.LoginRequestDto
import pt.iade.ei.runupsetup.data.dto.LoginResponseDto
import pt.iade.ei.runupsetup.data.dto.PersonalRecordDto
import pt.iade.ei.runupsetup.data.dto.PredefinedRouteDto
import pt.iade.ei.runupsetup.data.dto.TodaySummaryDto
...
import pt.iade.ei.runupsetup.data.dto.UserRegisterDto
import pt.iade.ei.runupsetup.data.dto.UserStatsDto
import pt.iade.ei.runupsetup.data.dto.WeeklyStatsDto
